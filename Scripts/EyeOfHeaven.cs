...
public static class EventPredictorRegistry
{
    ...
    private static IEnumerable<IEventPredictor> BuildAll()
    {
        ...
        yield return new BrainLeechPredictor();
        yield return new DoorsOfLightAndDarkPredictor();
        yield return new PotionCourierPredictor();
        yield return new RelicTraderPredictor();
        yield return new RoomFullOfCheesePredictor();
        yield return new SlipperyBridgePredictor();
        yield return new ThisOrThatPredictor();
        yield return new TheFutureOfPotionsPredictor();
        yield return new RanwidTheElderPredictor();
        yield return new PaelPredictor();
        yield return new WelcomeToWongosPredictor();
        yield return new OrobasPredictor();
        yield return new TheArchitectPredictor();
        yield return new StoneOfAllTimePredictor();
        yield return new SapphireSeedPredictor();
        yield return new ReflectionsPredictor();
        yield return new SpiritGrafterPredictor();
        yield return new SunkenTreasuryPredictor();
        yield return new WarHistorianRepyPredictor();
        yield return new WaterloggedScriptoriumPredictor();
        yield return new ColossalFlowerPredictor();
        yield return new CrystalSpherePredictor();
        yield return new DarvPredictor();
        yield return new GraveOfTheForgottenPredictor();
        yield return new LostWispPredictor();
        yield return new TheLegendsWereTruePredictor();
        yield return new TinkerTimePredictor();
        yield return new TeaMasterPredictor();
        yield return new TheLanternKeyPredictor();
        yield return new WellspringPredictor();
        yield return new WoodCarvingsPredictor();
        yield return new ZenWeaverPredictor();
        yield return new TabletOfTruthPredictor();
        yield return new SymbiotePredictor();
        yield return new UnrestSitePredictor();
        yield return new TrialPredictor();
        yield return new VakuuPredictor();
        yield return new TezcataraPredictor();
        yield return new TanxPredictor();
        yield return new RoundTeaPartyPredictor();
